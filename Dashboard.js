        ...
        <div className="container">
            <div className="sidebar">
                ...
                <ul>
                    ...
                    <li><Link to="/input-data" className={getLinkClass('/input-data')}>Input Data</Link></li>
                    <li><Link to="/tampil-data" className={getLinkClass('/tampil-data')}>Tampil Data</Link></li>
                </ul>
            </div>
            <div className="main-content">
                ...
                <div className="content">
                    <div className="statistics">
                        <div className="box">Disabilitas <h1>{10}</h1></div>
                        <div className="box">Anak <h1>{5}</h1></div>
                        <div className="box">Lansia <h1>{7}</h1></div>
                        <div className="box">Rentan <h1>{3}</h1></div>
                        <div className="box">Total <h1>{25}</h1></div>
                    </div>
                    <div className="chart">
